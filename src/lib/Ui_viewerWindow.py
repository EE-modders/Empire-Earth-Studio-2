...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.view_label_filename = QtWidgets.QLabel(Dialog)
        self.view_label_filename.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.view_label_filename.setFont(font)
        self.view_label_filename.setAlignment(QtCore.Qt.AlignCenter)
        self.view_label_filename.setObjectName("view_label_filename")
        self.verticalLayout.addWidget(self.view_label_filename)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.view_label_filename.setText(_translate("Dialog", "<filename of image>"))
