...
"")
        ...
        self.gridLayout_3.addWidget(self.tab_slc_select_out, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.tab_slc_select_in, 0, 0, 1, 1)
...
"")
        ...
        self.gridLayout_3.addWidget(self.tab_slc_label_in, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.tab_slc_label_out, 1, 1, 1, 1)
        ...
        self.pushButton.clicked.connect(self.tab_slc_list.clear)
        self.pushButton.clicked.connect(self.tab_slc_label_in.clear)
        self.pushButton.clicked['bool'].connect(self.tab_slc_slice.setEnabled)
        self.pushButton.clicked['bool'].connect(self.tab_slc_join.setEnabled)
